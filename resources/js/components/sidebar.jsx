...
import { Menu, X, Home, FileText, Users, Scale, BarChart2, Settings, UserCog, ClipboardList } from "lucide-react"; // ikon
  ...
  <h1 className="font-bold text-white text-lg drop-shadow text-center w-full">
    SMA Budhi Warman II
        ...
        <nav className="flex-1 p-5 space-y-2 text-white font-medium">
          ...
          <NavLink to="/ManajemenPendaftaran" className={linkClass} onClick={() => setIsOpen(false)}>
            <FileText size={18} /> Manajemen Pendaftaran
          </NavLink>
          <NavLink to="/siswa" className={linkClass} onClick={() => setIsOpen(false)}>
            <Users size={18} /> Data Siswa
          </NavLink>
          <NavLink to="/Kriteria" className={linkClass} onClick={() => setIsOpen(false)}>
            <Scale size={18} /> Kriteria & Bobot (SPK)
          </NavLink>
          <NavLink to="/Perhitungan" className={linkClass} onClick={() => setIsOpen(false)}>
            <BarChart2 size={18} /> Perhitungan & Hasil Seleksi
          </NavLink>
          <NavLink to="/ManajemenUser" className={linkClass} onClick={() => setIsOpen(false)}>
            <UserCog size={18} /> Manajemen User
          </NavLink>
          <NavLink to="/PengaturanSistem" className={linkClass} onClick={() => setIsOpen(false)}>
            <Settings size={18} /> Pengaturan Sistem
          </NavLink>
          <NavLink to="/Laporan" className={linkClass} onClick={() => setIsOpen(false)}>
