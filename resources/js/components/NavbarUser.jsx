...
export default function Navbar() {
    ...
    // ✅ ref untuk menyimpan status login sebelumnya
    ...
    // ✅ Tampilkan modal login hanya saat user baru login
    useEffect(() => {
        if (isLoggedIn && !prevIsLoggedIn.current) {
            setLoginModalOpen(true);
        }
        prevIsLoggedIn.current = isLoggedIn; // update status login sebelumnya
    }, [isLoggedIn]);
                ...
                : "opacity-0 -translate-y-2 pointer-events-none"
                                    ...
                                    >
                                        <NavLink
                                            to="/JalurZonasi"
                                            className={({ isActive }) =>
                                                `block px-4 py-2 hover:bg-gray-100 hover:text-[#05445E] ${
                                                    isActive
                                                        ? "font-semibold text-[#189AB4]"
                                                        : ""
                                                }`
                                            }
                                        >
