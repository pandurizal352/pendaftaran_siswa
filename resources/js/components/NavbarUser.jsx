...
export default function Navbar() {
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
                    <div className="flex items-center justify-between h-20">
                        ...
                        <div className="hidden lg:flex items-center gap-6 xl:gap-10">
                            ...
                            {isLoggedIn && (
                                <div className="relative" ref={dropdownRef}>
                                    <button
                                        ...
                                        className="hover:text-[#189AB4] transition-colors font-semibold"
                                    >
                                        Leaderboard
                                    </button>
                                    <div
                                    ...
                                    >
                                        <NavLink to="/JalurZonasi" className="block px-4 py-2 hover:bg-gray-100 hover:text-[#05445E]">Jalur Zonasi</NavLink>
                                        <NavLink to="/JalurPrestasi" className="block px-4 py-2 hover:bg-gray-100 hover:text-[#05445E]">Jalur Prestasi</NavLink>
                                        <NavLink to="/JalurNilai" className="block px-4 py-2 hover:bg-gray-100 hover:text-[#05445E]">Jalur Nilai</NavLink>
                                    </div>
                                </div>
                            )}
                            ...
                            {isLoggedIn ? (
                                <div className="flex items-center gap-4 ml-4">
                                    <span className="px-4 py-2 border rounded-md bg-white text-[#05445E]">
                                        {user.username}
                                    </span>
                                    <button
                                ...
                                <div className="flex items-center gap-3 ml-4">
                                    <a href="http://127.0.0.1:8000/register" className="px-4 py-2 border border-white rounded-md hover:bg-white hover:text-[#05445E] transition">Register</a>
                                    <a href="http://127.0.0.1:8000/login" className="px-4 py-2 bg-[#189AB4] text-white rounded-md hover:bg-[#75E6DA] transition hover:text-[#05445E]">Login</a>
                                </div>
                            )}
                        </div>
                        ...
                        <div className="lg:hidden flex items-center">
                            {!isOpen && <button onClick={() => setIsOpen(true)}><Menu className="w-7 h-7" /></button>}
                        </div>
                    </div>
                </div>
    ...
    <>
        ...
        <span className="px-3 py-2 rounded bg-gray-200">
            {user.username}
        </span>
        <button
            onClick={() => {
        ...
        <div className="mt-2 border-t pt-2">
            <span className="block px-3 py-2 font-semibold">
                Leaderboard
            </span>
            <NavLink
                to="/jalurzonasi"
