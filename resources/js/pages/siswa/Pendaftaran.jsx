...
export default function Pendaftaran() {
    const [form, setForm] = useState({
        ...
        alamat_sekolah_asal: "",
        rata_rata_nilai: "",
        jalur_id: "", // ← supaya tidak undefined
        nilai_tes: "", // ← supaya tidak undefined
        jarak_km: "", // ← supaya tidak undefined
        jenis_dokumen: [],
        tanggal_upload: "",
        file_path: [],
    });
...
//         <FormInput label="NISNoooo" name="nisn" value={form.nisn} onChange={onChange} required />
